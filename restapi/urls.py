...
urlpatterns = [
    ...
    path('football_list',views.FootballListCreate.as_view(),name='footballl_list'),
    path('football_list/<int:pk>/',views.FootballRetriveUpdateDelete.as_view(),name='update')
